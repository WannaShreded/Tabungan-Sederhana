...
public class Tabungan extends javax.swing.JFrame {
    ...
    String tgl = tanggal.getText().trim(); // Ambil tanggal dari input pengguna
    ...
    try {
        ...
        Date tanggalMutasi = sdf.parse(tgl); // Parse tanggal dari input
        ...
        try (Connection conn = DatabaseConnection.connect()) {
            if (conn != null) {
                ...
                try (PreparedStatement mutasiStmt = conn.prepareStatement(mutasiQuery)) {
                    ...
                    mutasiStmt.setDate(2, new java.sql.Date(tanggalMutasi.getTime())); // Gunakan tanggal dari input
